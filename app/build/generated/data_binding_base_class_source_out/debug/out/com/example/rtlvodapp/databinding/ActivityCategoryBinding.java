...
public final class ActivityCategoryBinding implements ViewBinding {
  ...
  private ActivityCategoryBinding(@NonNull LinearLayout rootView, @NonNull ImageView backButton,
      @NonNull TextView categoryTitle, @NonNull RecyclerView videoRecyclerView) {
  ...
  public static ActivityCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCategoryBinding((LinearLayout) rootView, backButton, categoryTitle,
          videoRecyclerView);
    }
